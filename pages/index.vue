        ...
        <div class="flex w-1/2 justify-end content-center">
          <a
            class="
              ...
              text-blue-300
              no-underline
              hover:text-indigo-800 hover:text-underline
              text-center
              h-10
              p-2
              md:h-auto md:p-4
    ...
    <div
      ...
      >
        <h1
          ...
          "
        >
          24 al 27 de noviembre del 2022
        </h1>
        <p
          class="
            leading-normal
          ...
          "
        >
          Parque Simón Bolivar, La Carlota, Estado Miranda
        </p>
      </div>

      <!--Footer-->
      <div class="w-full pt-16 pb-6 text-sm text-center fade-in">
        <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; Derechos reservados a quien sea 2022</a>
      </div>
    </div>
  </div>
</template>
